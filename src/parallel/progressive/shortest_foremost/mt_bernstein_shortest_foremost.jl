function threaded_progressive_bernstein_shortest_foremost(tg::temporal_graph,initial_sample::Int64,epsilon::Float64,delta::Float64,geo::Float64,verbose_step::Int64, bigint::Bool,algo::String = "trk")::Tuple{Array{Float64},Array{Int64},Float64,Float64}
