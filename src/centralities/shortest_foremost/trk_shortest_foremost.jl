...
struct BFS_SFM_SRTP_DS
    ...
    function BFS_SFM_SRTP_DS(nn::Int64, ntn::Int64)
        return new(Array{Int64}(undef, nn),Array{UInt128}(undef, nn), Array{Int64}(undef, nn), Array{UInt128}(undef, ntn), zeros(Int64, ntn), Array{Int64}(undef, ntn), Array{Set{Tuple{Int64,Int64,Int64}}}(undef, ntn+1), falses(ntn), Queue{Tuple{Int64,Int64,Int64}}())
    end
end

struct BI_BFS_SFM_SRTP_DS
    t_hit::Array{Int64}
    sigma::Array{BigInt}
    dist::Array{Int64}
    ...
    boolean_array::Array{Bool}
    forward_queue::Queue{Tuple{Int64,Int64,Int64}}
    function BI_BFS_SFM_SRTP_DS(nn::Int64, ntn::Int64)
        return new(Array{Int64}(undef, nn),Array{BigInt}(undef, nn), Array{Int64}(undef, nn), Array{BigInt}(undef, ntn), zeros(Int64, ntn), Array{Int64}(undef, ntn), Array{Set{Tuple{Int64,Int64,Int64}}}(undef, ntn+1), falses(ntn), Queue{Tuple{Int64,Int64,Int64}}() )
    end
end
